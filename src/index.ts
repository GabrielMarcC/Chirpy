...
app.post("/api/users", async (req: Request, res: Response, next) => {
  try {
...
app.put("/api/users", async (req: Request, res: Response, next) => {
  try {
...
app.post("/api/polka/webhooks", async (req: Request, res: Response, next) => {
  try {
...
app.post("/api/refresh", async (req: Request, res: Response, next) => {
  try {
...
app.post("/api/revoke", async (req: Request, res: Response, next) => {
  try {
